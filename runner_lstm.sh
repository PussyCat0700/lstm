...
#SBATCH --output=./logs/station_logs/3mcnnlstm_%A_%a.out
#SBATCH --error=./logs/station_logs/3mcnnlstm_%A_%a.err
...
do
    ...
    ckpt_dir=/data1/yfliu/solar_baseline/ablation_lstm/3m/lstm_$i
    mkdir -p $ckpt_dir
