...
#SBATCH --error=./logs/station_logs/nmg/gdboost_%A_%a.err
...
do
    ...
    mkdir -p $logdir
    python sklearn_train.py 2 --plant_number $plant_number --months $1 --plant_set "nmg" --plant_type 0 --period $2 > "$logdir/log.txt" 2>&1 &
done
wait