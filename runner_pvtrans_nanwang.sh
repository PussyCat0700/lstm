...
#SBATCH --job-name=pvtrans_e_nanwang
...
#SBATCH --output=./logs/station_logs/nanwang/pvtrans_e_%A_%a.out
#SBATCH --error=./logs/station_logs/nanwang/pvtrans_e_%A_%a.err
