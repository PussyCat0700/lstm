...
#SBATCH --job-name=cnnlstm_china_real
...
#SBATCH --output=./logs/station_logs/china_real/cnnlstm_%A_%a.out
#SBATCH --error=./logs/station_logs/china_real/cnnlstm_%A_%a.err
