...
#SBATCH --job-name=xgboost_china_wnd
...
do
    ...
    mkdir -p $logdir
    python sklearn_train.py 0 --plant_number $plant_number --months $1 --plant_set "china" --plant_type 0 --period 24 > "$logdir/log.txt" 2>&1 &
done
wait