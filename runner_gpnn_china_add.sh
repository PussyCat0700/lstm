...
#SBATCH --job-name=gpnn_china_add
...
#SBATCH --output=./logs/station_logs/china_add/gpnn_%A_%a.out
#SBATCH --error=./logs/station_logs/china_add/gpnn_%A_%a.err
...
do
    ...
    logdir=/data1/yfliu/logs/solar/china_add/gpnn/${1}_${task_id}_${plant_number}
