...
do
    ...
    mkdir -p $logdir
    CUDA_VISIBLE_DEVICES=$gpu_id python train.py 5 --plant_set china_add --plant_number $plant_number --months $1 --batch_size 128 --plant_type 1 > "$logdir/log.txt" 2>&1 &
done
wait