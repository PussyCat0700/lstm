...
#SBATCH --job-name=24crossvt_nanwang
...
do
    ...
    python train.py 4 --plant_set nanwang --plant_number $plant_number --months $1 --batch_size 20 --num_epochs 16 --plant_type 1 --period 24 &
done
wait
